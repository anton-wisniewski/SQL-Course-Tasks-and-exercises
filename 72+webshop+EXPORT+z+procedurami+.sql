...
--
-- Host: 127.0.0.1
-- Generation Time: Lip 02, 2023 at 10:09 AM
...
-- Procedury
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `calculateOrderTotal` (IN `order_id` INT, OUT `total` DECIMAL(10,2))   BEGIN
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `countProducts` (OUT `product_count` INT)   BEGIN
	DECLARE total INT;
